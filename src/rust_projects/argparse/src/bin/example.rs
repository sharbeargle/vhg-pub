...
fn main() {
    let arg_config = argparse::new_argconfig()
        ...
        .add_named_argument("arg1".to_string(), true, "Arg1 input".to_string())
        .add_named_argument("arg2".to_string(), false, "arg2 input".to_string())
        .add_named_argument("arg3".to_string(), false, "arg3 input".to_string())
